...
if (isset($_POST['send'])) {	
	...
	$user_serial = mysql_real_escape_string($user_serial);
	$user_category = $_POST['user_category'];
	$user_category = mysql_real_escape_string($user_category);
	$query = mysqli_query($myConnection, "INSERT into search  (user_name, user_serial, user_category) values('$user_name', '$user_serial', '$user_category') ") or die (mysqli_error($myConnection));
